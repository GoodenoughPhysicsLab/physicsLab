...
class _mems_Base(CircuitBase):
    ...
    def __init__(self, x: numType = 0, y: numType = 0, z: numType = 0, elementXYZ: Optional[bool] = None):
        self.data: CircuitElementData = {"ModelID": Generate, "Identifier": Generate, "Label": None,
                           "IsBroken": False, "IsLocked": False,
                           "Properties": { "量程": Generate, "输出阻抗": 10000, "偏移": Generate, "响应系数": Generate },
                           "Statistics": {},
...
class Analog_Joystick(CircuitBase):
    ''' 模拟摇杆 '''
    def __init__(self, x: numType = 0, y: numType = 0, z: numType = 0, elementXYZ: Optional[bool] = None):
        self.data: CircuitElementData = {"ModelID": "Analog Joystick", "Identifier": Generate, "Label": None,
                           "IsBroken": False, "IsLocked": False,
                           "Properties": { "额定电阻": 10000 },
                           "Statistics": {},
                           "Position": Generate, "Rotation": Generate, "DiagramCached": False,
                           "DiagramPosition": { "X": 0, "Y": 0, "Magnitude": 0 },
                           "DiagramRotation": 0}
...
class Photodiode(TwoPinMixIn):
    ''' 光电二极管 '''
    def __init__(self, x: numType = 0, y: numType = 0, z: numType = 0, elementXYZ: Optional[bool] = None):
        self.data: CircuitElementData = {"ModelID": "Photodiode", "Identifier": Generate, "Label": None,
                           "IsBroken": False, "IsLocked": False,
                           "Properties": { "前向压降": 0.6, "击穿电压": 0, "额定电流": 1, "响应系数": 0.1, "响应时间": 0.03 },
                           "Statistics": {},
                           "Position": Generate, "Rotation": Generate, "DiagramCached": False,
                           "DiagramPosition": { "X": 0, "Y": 0, "Magnitude": 0 },
                           "DiagramRotation": 0}
...
class Photoresistor(TwoPinMixIn):
    ''' 光敏电阻 '''
    def __init__(self, x: numType = 0, y: numType = 0, z: numType = 0, elementXYZ: Optional[bool] = None):
        self.data: CircuitElementData = {"ModelID": "Photoresistor", "Identifier": Generate, "Label": None,
                           "IsBroken": False, "IsLocked": False,
                           "Properties": { "亮电阻": 10000, "暗电阻": 1000000, "响应时间": 0.03, "最大电压": 150, "响应系数": 0.6 },
                           "Statistics": {},
                           "Position": Generate, "Rotation": Generate, "DiagramCached": False,
                           "DiagramPosition": { "X": 0, "Y": 0, "Magnitude": 0 },
                           "DiagramRotation": 0}
...
class Proximity_Sensor(_logicBase):
    ''' 临近传感器 '''
    def __init__(self, x: numType = 0, y: numType = 0, z: numType = 0, elementXYZ: Optional[bool] = None):
        self.data: CircuitElementData = {"ModelID": "Proximity Sensor", "Identifier": Generate, "Label": None,
                           "IsBroken": False, "IsLocked": False,
                           "Properties": { "高电平": 3, "低电平": 0, "输出阻抗": 10000 },
                           "Statistics": {},
                           "Position": Generate, "Rotation": Generate, "DiagramCached": False,
                           "DiagramPosition": { "X": 0, "Y": 0, "Magnitude": 0 },
                           "DiagramRotation": 0}
